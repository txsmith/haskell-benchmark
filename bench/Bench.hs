...
chopSpecialized 3 final w = chopSpecialized 2 final w >>
                            chopSpecialized 1 final (shiftR w 16)
chopSpecialized 4 final w = poke (castPtr final) (asWord32 w)
chopSpecialized 5 final w = chopSpecialized 4 final w >>
                            chopSpecialized 1 final (shiftR w 32)
chopSpecialized 6 final w = chopSpecialized 4 final w >>
                            chopSpecialized 2 final (shiftR w 32)
chopSpecialized 7 final w = chopSpecialized 4 final w >>
                            chopSpecialized 2 final (shiftR w 32)
